...
<style>
    ...
    <nav class="menu">
        ...
        <a href="adminHomepage.php"><img src="OIG.jpg" alt="" height="80px"  class="logo w3-animate-top"></a>
        <ul>
            <?php
            
            if(isset($_SESSION['adminLogedin'])){
            echo"<li><a href='adminHomepage.php' class = 'active'>Home</a></li>
            <li><a href='adminSearch.php'>Search</a></li>
            <li><a href='adminIndexex3.php'>Product</a></li>
            <li><a href='adminIndexex4.php'>Product+images</a></li>
